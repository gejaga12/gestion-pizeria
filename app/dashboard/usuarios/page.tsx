        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {[
                { name: 'Ana García', email: 'ana@pizzahub.com', role: 'Cajero', branch: 'Sucursal Centro', status: 'Activo' },
                { name: 'Carlos López', email: 'carlos@pizzahub.com', role: 'Cocinero', branch: 'Sucursal Norte', status: 'Activo' },
                { name: 'María Rodríguez', email: 'maria@pizzahub.com', role: 'Mesero', branch: 'Sucursal Sur', status: 'Inactivo' },
              ].map((user, index) => (
                <tr key={index}>
